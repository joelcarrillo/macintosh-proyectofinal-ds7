            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="?op=facultades">Facultades</a></li>
                            <li class="pc-item"><a class="pc-link" href="?op=salones">Salones</a></li>
                            <li class="pc-item"><a class="pc-link" href="?op=horarios">Ver Horarios</a></li>
                        </ul>
                    </li>

                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link "><span class="pc-micon"><i data-feather="database"></i></span><span
                                class="pc-mtext">Administración</span><span class="pc-arrow"><i
