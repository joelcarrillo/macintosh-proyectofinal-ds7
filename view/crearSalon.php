                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="?op=crearNuevoSalon">Crear nuevo salon</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="card text-left">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Salon <?php echo '' ?></h5>
                            ...
                            <div class="card-descripcion">
                                <div class="card-text">Edificio:</div> <span></span>
                            </div>
                            <div class="card-descripcion">
                                <div class="card-text">Piso:</div> <span></span>
                            </div>
                            <br>
